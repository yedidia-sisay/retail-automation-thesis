...
#figure(
  ...
  caption: [Abbreviations and acronyms used in the report],
)
...
However, RPC cannot be used directly as the only dataset for this thesis because the target products are Ethiopian supermarket products. Many products in local supermarkets are not represented in RPC. 
...
#figure(
  ...
  caption: [Comparison of related checkout automation systems and studies],
)
...
#figure(
  ...
  caption: [Functional requirements of the proposed checkout automation system],
)
...
#figure(
  ...
  caption: [Non-functional requirements of the proposed checkout automation system],
)
...
#figure(
  ...
  caption: [Project success criteria and target values],
)
...
#figure(
  ...
  caption: [Prototype hardware stack and component roles],
)
...
#figure(
  ...
  caption: [Prototype software stack and technology roles],
)
#pagebreak()
...
#figure(
  ...
  caption: [Software frameworks and libraries used in the prototype],
)
...
#figure(
  ...
  caption: [Packaged-product dataset class list],
)
...
#figure(
  ...
  caption: [Training, validation, and test split of the grocery dataset],
)
...
#figure(
  ...
  caption: [YOLOv8n training configuration for packaged-product detection],
)
...
[$"mAP@50-95"$], [0.8316],
  ...
  caption: [Validation performance of the trained packaged-product detector],
)
...
#figure(
  ...
  caption: [Weighted-product produce class list],
)
=== Image Capture Protocol
...
#figure(
  ...
  caption: [Cropper model classes for weighted-product region detection],
)
...
#figure(
  ...
  caption: [Digit and decimal-point detection classes for scale display reading],
)
...
#figure(
  ...
  caption: [Weighted-product model components and exported deployment package],
)
...
#figure(
  ...
  caption: [Unit-level checkout test plan],
) <tab-unit-test-plan>
...
#figure(
  ...
  caption: [Packaged-product integration test results],
...
#figure(
  ...
  caption: [Weighted-product subsystem integration test results],
...
#figure(
  ...
  caption: [Packaged-product detection model performance],
...
#figure(
  ...
  caption: [Packaged-product backend API latency results],
...
#figure(
  ...
  caption: [Packaged-product detection-count summary],
...
#figure(
  ...
  caption: [Weighted-product vision pipeline latency results],
...
#figure(
  ...
  caption: [Weighted-product component latency results],
...
#figure(
  ...
  caption: [Summary of main prototype evaluation findings],
)
...
The objectives of the project were generally met. A custom Ethiopian grocery-product dataset was collected, filtered, annotated, and used to train a YOLOv8n object detection model. The model was evaluated using standard detection metrics and achieved results above the defined target values. The Django backend, React cashier interface, product-matching workflow, draft receipt generation, barcode fallback support, and performance testing were also implemented at prototype level. The system successfully demonstrated the intended cashier-assisted checkout workflow, where computer vision suggests products and the cashier reviews and confirms the final transaction.

The main incomplete area is the full integration of the weighted-product workflow into the complete checkout system. The weighted-product vision pipeline was developed and tested separately, including produce recognition, display cropping, digit detection, and weight reconstruction. However, it was not fully connected end-to-end with backend pricing, ERP lookup, cashier confirmation, and final receipt insertion. Therefore, the overall project objectives were met, but weighted-product full integration remains a future improvement.
